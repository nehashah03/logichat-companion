...
//   /**
//    * Used by UI to show retry button on failed assistant response.
//    */
//   retryQuery?: string;

//   /**
//    * User-friendly error text for this message.
//    */
//   error?: string;
...
//   /**
//    * Current visual stage shown in UI.
//    */
//   pipelineStage: PipelineStage;

//   /**
//    * Live backend-driven pipeline.
//    * Do not pre-hardcode steps in UI.
//    * Backend events create/update this.
//    */
//   livePipeline: PipelinePhase[];

//   /**
//    * Assistant message currently receiving tokens.
//    */
//   liveAssistantId: string | null;

//   /**
//    * Current backend turn id.
//    */
//   liveTurnId: string | null;

//   /**
//    * Timer value used by UI.
//    */
//   elapsedTime: number;
...
//       assistantMessage.pipeline = state.livePipeline;
//     }
//   }
// }
...
//       if (message) {
//         message.pipeline = action.payload.pipeline;
//       }
//     },

//     /* ========================================================
//        LIVE PIPELINE
//        Existing name kept. No duplicate initLive reducer.
//        ======================================================== */
...
//       }>,
//     ) {
//       const phase = findPhase(state, action.payload.phaseKey);
//       if (!phase) return;
...
//        This is the main reducer your websocket hook can call.
//        ======================================================== */
...
//         assistantId || state.liveAssistantId;
...
//           const phase = findPhase(state, event.phase);
...
//               message.pipeline = state.livePipeline;
//             }
//           }
